        ...
        >
          ...
          <div class="hidden lg:relative lg:block lg:p-12">
            ...
            <p class="mt-4 leading-relaxed text-white/90">
              Grab your account and learning with us !
            </p>
          </div>
        </section>
          ...
          <div class="max-w-xl lg:max-w-3xl">
            ...
            <form action="#" class="mt-8 grid grid-cols-6 gap-6">
              <div class="col-span-6">
                ...
                />
                <span class="text-red-500">{{ valiUsername }}</span>
                <label
                  for="Email"
                  class="block text-sm mt-5 font-medium text-gray-700 dark:text-gray-200"
                >
                  Email
                </label>
                ...
                <input
                  ...
                  class="mt-1 w-full h-8 rounded-md border-gray-200 bg-white text-md text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                />
                <span class="text-red-500">{{ valiEmail }}</span>
              </div>
              <div class="col-span-6">
                <label
                  for="Password"
                ...
                <input
                  ...
                  class="mt-1 w-full h-8 rounded-md border-gray-200 bg-white text-md text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                />
                <span class="text-red-500">{{ valiPassword }}</span>
                <label
                  for="Password"
                  class="block text-sm font-medium mt-5 text-gray-700 dark:text-gray-200"
                >
                  Confirm password
                </label>
                ...
                <input
                  ...
                  class="mt-1 w-full h-8 rounded-md border-gray-200 bg-white text-md text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                />
                <span class="text-red-500">{{ emessage }}</span>
              </div>
      ...
      try {
        ...
        if (e.response && e.response.data) {
          ...
          if (e.response.data.errors && Array.isArray(e.response.data.errors)) {
            ...
            this.errorValidation = e.response.data.errors;
            ...
            this.errorValidation.forEach((error) => {
              if (error.path === "username") {
                this.valiUsername = error.msg;
              } else if (error.path === "password") {
                this.valiPassword = error.msg;
              } else if (error.path === "email") {
                this.valiEmail = error.msg;
              } else if (error.path === "") {
                this.valiEmail = "";
                this.valiPassword = "";
                this.valiUsername = "";
            ...
            this.emessage = e.response.data.message;
          } else {
            // Handle other types of errors
            this.emessage = "An error occurred. Please try again.";
          }
        } else {
