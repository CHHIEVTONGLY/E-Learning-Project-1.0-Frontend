        ...
        try {
          ...
          if (userDetails) {
            ...
            const { data } = await axios.post(
              process.env.VUE_APP_BASE_URL + "/user/register-google",
              {
            ...
            console.error("Failed to decode user details");
          }
        } catch (error) {
  ...
  methods: {
    async login() {
      ...
      try {
        ...
        sessionStorage.setItem("e-token", token);
        this.$router.push("/course/all");
      } catch (e) {
